...
$modelsToTest = [
    'wan2.6-t2i',           // 新端点 - 同步
    'wan2.2-t2i-flash',     // 旧端点 - 异步
    'wanx-v1',              // 旧端点 - 异步
    'qwen-image-2.0-pro',   // 新端点 - 同步
    'qwen-image-2.0',       // 新端点 - 同步
];
...
// 保存结果
file_put_contents(__DIR__ . '/test_safe_results.json', json_encode($results, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES));
echo "Results saved to test_safe_results.json\n";
